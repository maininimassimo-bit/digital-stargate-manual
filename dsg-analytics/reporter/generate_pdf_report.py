...
def main():
 ...
 story += [Spacer(1,12),Paragraph('Nota: l RMS PHD2 usa gli scarti grezzi RA/DEC convertiti con la scala pixel del segmento; il settling e escluso e STAR_SATURATED (ErrorCode 1) e incluso ma tracciato separatamente.',styles['BodyText']),Spacer(1,8),Paragraph('Nota: i valori SQM provengono dalla proiezione canonica della sessione; n/d indica telemetria SQM non disponibile. La telemetria SQM e scientifica e non costituisce Safety Authority.',styles['BodyText']),Spacer(1,8),Paragraph('Nota: lo stato meteo Unsafe dell intera finestra e informativo fino alla correlazione con sequenza attiva e cupola aperta.',styles['BodyText'])]
 doc.build(story)
