...
const stateSha = "151721051c7f93db039fcfbc7fd14c0500e7beb37fbb406f1a17d35ca63adb41";
...
if (crypto.createHash("sha256").update(evidenceBytes).digest("hex") !== "66a6aec6f87f4e82806a5141035a4225419ddd9a1b9c8abbb2b667c362cd4cb1") fail("remediated platform update evidence raw digest mismatch");
...
if (evidence.platformState?.serial !== 6 || evidence.platformState?.rawSha256 !== stateSha || evidence.platformState?.resourceCount !== 4 || evidence.platformState?.immediateDrift !== "ZERO") fail("remediated platform state mismatch");
