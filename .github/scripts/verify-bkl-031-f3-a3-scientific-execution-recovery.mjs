...
if (incident.status !== "PLATFORM_REMEDIATED_REPLACEMENT_EXECUTION_REVIEW_REQUIRED") fail("scientific execution incident status mismatch");
...
if (incident.controls?.secondExecution !== "PROHIBITED_NOT_EXECUTED" || incident.controls?.recoveryMode !== "PLATFORM_REMEDIATED_REPLACEMENT_EXECUTION_REQUIRES_SEPARATE_GATE") fail("scientific execution incident recovery boundary mismatch");
