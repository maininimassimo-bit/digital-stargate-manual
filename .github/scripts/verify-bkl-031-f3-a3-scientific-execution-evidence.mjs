...
exact(roadmap.nextMilestone, "BKL-031 F4-B machine-readable forecast contracts, TEST/NONE fixture and validator", "roadmap next milestone mismatch");
...
console.log("BKL-031 F3-A3 scientific execution evidence verified: dsg-f3-a3-spike-g4x8g; 8 vectors; 17/17 metrics; repeatability/transit pass; Accepted/Post-Merge Verified; F3-B Accepted/Post-Merge Verified");
