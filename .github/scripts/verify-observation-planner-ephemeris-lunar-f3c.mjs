...
for (const fragment of ['data-observation-planner', 'F4-A accettata', 'fixture astronomica sintetica F3-C']) assert.ok(page.includes(fragment), `Observation Planner page missing: ${fragment}`);
