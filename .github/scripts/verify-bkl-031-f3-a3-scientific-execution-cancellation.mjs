...
if (incident.status !== "READ_ONLY_RECOVERY_COMPLETE_STUCK_EXECUTION_CANCELLATION_REQUIRED") fail("incident status does not authorize exact cancellation recovery");
