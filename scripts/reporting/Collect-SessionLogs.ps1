...
@($ninaDest, $phd2Dest, $weatherDest, $reportDest) | ForEach-Object { Ensure-Directory $_ }
...
Write-Host "N.I.N.A.: $($nina.Count) file; PHD2: $($phd2.Count) file; Meteo: $weatherOutput; Stato: $status"
