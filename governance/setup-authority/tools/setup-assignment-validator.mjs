...
export function validateBinding(r,d,site,baseline){
 ...
 add(errors,p.validity.validFromUtc===x.validity.validFromUtc&&p.validity.validityEndMode===x.validity.validityEndMode&&p.validity.validToUtc===x.validity.validToUtc&&p.validity.intervalSemantics===x.validity.intervalSemantics,"DECISION_VALIDITY_BINDING_FAILED");
