...
| Ruolo | Acquisizione scientifica monocromatica |

## Descrizione

Camera mono usata con filtri LRGB e narrowband. La baseline deve includere driver, raffreddamento, gain, offset e configurazioni di binning.
