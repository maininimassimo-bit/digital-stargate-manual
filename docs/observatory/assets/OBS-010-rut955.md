...
| Ruolo | Gateway, VPN e failover WAN |

## Descrizione

Router industriale con indirizzo 192.168.1.1. Gestisce VPN e failover Starlink → SIM1 → SIM2. Backup e watchdog devono essere testati.
