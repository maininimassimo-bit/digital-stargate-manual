...
| Ruolo | Produzione dello stato meteo e safety |

## Descrizione

Componente logico/fisico da consolidare nella baseline. Deve produrre uno stato deterministico SAFE, WARNING o UNSAFE.
