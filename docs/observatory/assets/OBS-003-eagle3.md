...
| Ruolo | Control host dell'osservatorio |

## Descrizione

Computer edge Windows che ospita N.I.N.A., PHD2, CPWI, driver ASCOM e servizi di automazione. Costituisce il principale control plane locale.
