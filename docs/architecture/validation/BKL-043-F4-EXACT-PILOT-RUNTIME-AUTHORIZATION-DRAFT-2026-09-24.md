...
| Local receipt outbox / delayed delivery | On 2026-09-26 Massimo Mainini selected preserving locally produced receipts through network interruption and sending them after reconnection. This only covers observations created while the source operates and does not evidence activity while EAGLE is off. | **OWNER DESIGN DIRECTION RECORDED; capacity, durability, access controls, retry/ack, late-receipt reconciliation and local installation authorization pending** |
