...
| Sampling/heartbeat cadence, timeout, freshness and gap semantics | On 2026-09-26 Massimo Mainini selected one receipt per minute as a design cadence. Historical producer cadence is not transferable; timeout, freshness, deadline, retry and gap/`UNKNOWN` semantics remain unresolved. | **ONE-MINUTE DESIGN CADENCE RECORDED; contract details and runtime authorization pending** |
