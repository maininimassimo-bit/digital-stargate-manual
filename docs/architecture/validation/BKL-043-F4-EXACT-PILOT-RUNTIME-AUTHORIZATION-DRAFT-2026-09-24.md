...
| Local receipt outbox / delayed delivery | On 2026-09-26 Massimo Mainini selected preserving locally produced receipts through network interruption and sending them after reconnection; he also selected survival of source reboot and unexpected power loss as the design objective. This only covers observations created while the source operates and does not evidence activity while EAGLE is off. Power-loss durability is a requirement to verify, not a proven guarantee. | **OWNER DESIGN DIRECTION RECORDED; persistence mechanism/flush semantics, capacity, disk-full/corruption recovery, access controls, retry/ack, late-receipt reconciliation and local installation authorization pending** |
