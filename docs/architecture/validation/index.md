...
- [F5 Real-Evidence Evaluation Plan](BKL-046-F5-Real-Evidence-Evaluation-Plan.md) — technical-head CI complete; implementation rework required; F5-B/F5-C not executed
