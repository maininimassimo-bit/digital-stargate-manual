...
| Stato | Active validation campaign — C01/C05 simulated scope completed |
...
| ARB-012-C02 | Not Executed | Not Executed | alarm and incident validation da eseguire |
...
| E-ARB012-C02-01 | C02 | Missing | da produrre |
...
## 4. Quality-gate evidence C01/C05

Developer Foundation run `30579353794`, run number 179, job `90995432630`, ha completato con successo:
...
Il risultato copre esclusivamente fixture e componenti simulati. Nessun endpoint, adattatore o dispositivo operativo è stato validato.
...
1. mantenere C01/C05 e C08 verificati nello scope dichiarato;
2. eseguire C02 — Alarm and Incident Validation;
3. eseguire C03 — Runbook Drill and Recovery;
4. validare C06 — Degraded Mode and Dependency Failure;
5. validare C07 — Audit, Retention and Time Integrity;
6. completare C04 con identità distinte, sostituti, access review e prove four-eyes;
7. eseguire una validazione integrata non operativa;
8. sottoporre C01–C08 a re-review ARB finale;
9. valutare separatamente qualsiasi futura readiness runtime.
...
C01 e C05 hanno validazione tecnica simulata completa; C08 è verificata. C02, C03, C06 e C07 non sono eseguite e C04 è bloccata dalla configurazione organizzativa a identità unica. C3/C4 runtime, break-glass runtime e self-approval restano proibiti.
