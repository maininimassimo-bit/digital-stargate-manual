...
| Stato | Active validation campaign — C01/C02/C03/C05/C06/C07 simulated scope completed |
...
1. mantenere C01/C02/C03/C05/C06/C07 e C08 verificati nello scope dichiarato;
2. completare C04 con identità distinte, sostituti, access review e prove four-eyes;
3. eseguire una validazione integrata non operativa;
4. sottoporre C01–C08 a re-review ARB finale;
5. valutare separatamente qualsiasi futura readiness runtime.
...
C01, C02, C03, C05, C06 e C07 hanno validazione tecnica simulata completa; C08 è verificata. C04 resta bloccata dalla configurazione organizzativa a identità unica e la validazione integrata non operativa non è stata eseguita. C3/C4 runtime, break-glass runtime e self-approval restano proibiti.