...
F3-C is Accepted / Post-Merge Verified through PR #261 and merge `fba1287efea0d1f36b147bc42a4fec5498990756`. Its repository-only bounded adapter, sanitized projection, browser validation and read-only portal consumer passed the 35-case suite, all 12 applicable post-merge workflows and direct deployed-route verification. P10 and the repository-applicable portions of P04/P06/P08 and N41/N45/N46/N50/N51/N53–N66 are exercised without protected data or runtime activity.
