...
The F3-B Accepted / Post-Merge Verified gate materializes the three source-neutral schemas, one bounded synthetic fixture and a deterministic validator. Its 34-case suite executes the F3-B-applicable method/request/evidence, validity, fact-range, privacy, prohibited-field and authority-boundary cases. The accepted F3-A1/F3-A2 suites remain authoritative for full site/setup lifecycle and overlap behavior. F3-B does not claim that the complete integration/OAT campaign is executed.

The F3-C candidate implements a repository-only bounded adapter over accepted synthetic evidence, a sanitized projection, browser validation and a read-only portal consumer. Its 35-case suite covers deterministic integration, exact fact preservation, validity, Citation/Provenance, privacy, digest integrity, prohibited capabilities and authority boundaries. P10 and the repository-applicable portions of P04/P06/P08 and N41/N45/N46/N50/N51/N53–N66 are exercised without protected data or runtime activity.

Protected-site calculation, external-reference traffic, production scientific execution and runtime activation remain not executed. S10 remains `UNAVAILABLE`; cases requiring protected authorities or a production runtime remain open for a separately authorized gate.
