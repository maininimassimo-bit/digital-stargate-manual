...
PR #239 merged the exact runner publication gate as `9db0267529b6d46a2510b415e4b3f51d668ff024` after 7/7 exact-head checks, ARB approval, Release Quality readiness and 4/4 post-merge workflows. Run `35150960879` reproduced OCI manifest `sha256:69a20a994fde9d5b1533b142760af5796b4ac795a1f00c658373a46d2648d60c` and config `sha256:333e5d1b303dda4c5a4037f386b2f56a7f967a9197bbb4186ca6f33dfd4c4cc3` through two no-cache network-disabled builds plus a no-push registry-exporter preflight. It published exactly tag `runner-9db0267529b6`, preserved the prior preflight image and post-verified the exclusive two-image inventory. `BKL-031-F3-A3-RUNNER-OCI-PUBLICATION-EVIDENCE-001` records the result at SHA-256 `0b7992c257580c964118a09954615c75620b2c1018a7184ae02be8d101cbb23f`. Platform mutation, job execution and scientific execution remain `NOT_EXECUTED`; the next gate is the separately reviewed exact one-update runner platform apply.
