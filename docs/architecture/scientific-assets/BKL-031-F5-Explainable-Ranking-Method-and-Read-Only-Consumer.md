...
With F5 Accepted/Post-Merge Verified, **F6 — capability closure** becomes the next separately governed BKL-031 slice. F6 must reconcile the complete F1–F5 evidence chain and close BKL-031 without expanding scope into BKL-032 readiness, production scheduler behavior, protected-site provider acquisition, commands or Safety Authority.
