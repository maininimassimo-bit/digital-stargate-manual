...
La validazione locale del proposal comprende 16/16 test F2 e 20/20 test F3. L'evidence CI exact-head, la review ARB indipendente e il gate Release Quality restano requisiti di acceptance.
