...
| AP-008 | Enterprise Integration | AP-008, INT-REF-001, INT-CAT-001, INT-SESSION-METADATA-PILOT-001 | ARB-AP008 | Rework Required; pilot proposed; no runtime authorization |
...
| ARB-AP008 | Independent Review of AP-008 | AP-008 | Completed — Rework Required | 74/100; conditions open; no runtime authorization |
