...
| CAP-15 AllSky integration | Planned | PAA-002 / AP-008 | adapter candidate | ARB-002; nessuna review AP-008 | Contratti e health richiesti |
...
| CAP-18 AI boundary contracts | Prepared | PAA-002 / AP-008 | contratti presenti e integration boundary proposto | ARB-004/006/007; nessuna review AP-008 | Nessun privilegio implicito |
...
| CAP-34 Enterprise Analytics Platform | Planned | AMP-002 / DSGP-VIS-001 / AP-008 | vision e integration gates | Nessuna review AP-011 | DSAP governato |
| CAP-35 Enterprise Operations Center | Planned | AMP-002 / DSGP-VIS-001 / AP-008 | vision e command/query boundary | Nessuna review AP-012 | DSOC read-only first |
| CAP-36 Digital StarGate Portal | Planned | AMP-002 / DSGP-VIS-001 / AP-008 | vision e API boundary | Nessuna review AP-011/AP-012 | Non safety authority |
| CAP-37 Scientific Image Repository | Planned | AMP-002 / SIR-VIS-001 / AP-008 | vision e binary-reference pattern | Nessuna review AP-013 | Storage esterno |
| CAP-38 Scientific Observation Catalog and Search | Planned | AMP-002 / SIR-VIS-001 / AP-008 | catalogo e reconciliation pattern | Nessuna review AP-014 | Catalogo e manifest |
| CAP-39 Scientific Processing Provenance | Planned | AMP-002 / SIR-VIS-001 / AP-008 | contratto proposto | Nessuna review AP-013/AP-014 | Processing Run immutabili |
| CAP-40 Scientific Knowledge Layer | Planned | AMP-002 / SKL-VIS-001 / AP-008 | vision e reconciliation gate | Nessuna review AP-015 | Claim e citation governati |
...
| AP-007 | Operations and Service Management | package AP-007 e OPS-REF-001 | Nessuna registrata | Proposed for independent ARB review |
| AP-008 | Enterprise Integration | package AP-008, INT-REF-001, INT-CAT-001 | Nessuna | Proposed for independent ARB review |
...
## 5. Integration Artifact Register
...
| ADP-NINA-001 | N.I.N.A. Adapter | AP-008 | Candidate | non implementato |
| ADP-PHD2-001 | PHD2 Adapter | AP-008 | Candidate | non implementato |
| ADP-CPWI-001 | CPWI Adapter | AP-008 | Candidate | non implementato |
| ADP-DOME-001 | Dome/PLC Adapter | AP-008 | Candidate | non implementato |
| ADP-WX-001 | Weather Adapter | AP-008 | Candidate | non implementato |
| ADP-ALLSKY-001 | AllSky Adapter | AP-008 | Candidate | non implementato |
| ADP-PIX-001 | PixInsight Adapter | AP-008 | Candidate | non implementato |
| ADP-STORAGE-001 | Storage Adapter | AP-008 | Candidate | non implementato |
| ADP-GH-001 | GitHub Adapter | AP-008 | Candidate | non implementato |

## 6. Assessment and governance chain
...
| AP-008 / INT-REF-001 / INT-CAT-001 | Enterprise Integration | Proposed for independent ARB review |

## 7. Open traceability gaps
...
| TR-G16 | Command authorization incompleta | comandi non governabili | AP-005/AP-008/AP-012 |
...
| TR-G39 | Protocollo live/freshness non deliberato | stato DSOC ingannevole | AP-008/AP-012; contract test richiesto |
| TR-G40 | BFF e command path non definiti | rischio UI-to-device | AP-008/AP-012; threat model richiesto |
...
| TR-G45 | Reconciliation sync non testata | divergenza catalogo/storage | AP-008/AP-014; PoC richiesto |
| TR-G46 | Credenziali adapter non definite | esposizione token | AP-005/AP-008; security review richiesta |
...
| TR-G54 | Knowledge reconciliation non testata | indice stale | AP-008/AP-015; PoC richiesto |
...
| TR-G61 | Contract registry owner non nominato | versioni e approvazioni non attribuibili | AP-008 governance assignment |
| TR-G62 | Adapter runtime non implementati o certificati | integrazioni solo documentali | pilot AP-008 |
| TR-G63 | Duplicate, ordering, timeout e replay non testati | perdita o doppia elaborazione | failure-injection suite |
| TR-G64 | Dead-letter ownership e retention non deliberate | errori accumulati o persi | AP-008/AP-009 operational policy |
| TR-G65 | Command outcome unknown non collaudato | ripetizione pericolosa di azioni | reconciliation e command exercise |
| TR-G66 | Protocolli e middleware non selezionati | deployment non definito | AP-009 decisione technology-specific |
| TR-G67 | Contract compatibility automation assente | breaking change non rilevate | schema registry/CI future |
| TR-G68 | Binary payload e URI policy non deliberata | immagini duplicate o link fragili | AP-009/AP-013 |

## 8. Validazione del registro

Il registro include AP-008, INT-REF-001 e INT-CAT-001 come artefatti proposti o candidati. Non certifica middleware, adapter, contract registry, pubblicazione runtime, autorizzazioni di comando, exactly-once, reconciliation, readiness o risultato di una review ARB indipendente. AP-007 resta proposto per review perché nessun artefatto ARB-009 è verificato nel repository.