...
<section class="dsg-op-hero">
  <div><span>BKL-031 · OBSERVATION PLANNER INTELLIGENTE</span><h1>Observation Planner</h1><p>Vista read-only di evidence astronomica e contesto forecast governati. Le projection pubbliche sono sanificate e non costituiscono ranking, readiness, go/no-go, comando o Safety Authority.</p></div>
