...
| BKL-036 | P2 | Observatory Health Score | In Progress | BKL-030, telemetry history | F3 archived-evidence score published; F4 governed read-only snapshot import and repository archival | F1/F2/F3 integrated; F4 implementation candidate; no live transport, readiness, remediation or commands authorized |
