...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-C Accepted/Post-Merge Verified with 35/35 tests; F4-A source discovery, proposed ADR-011, explicit ItaliaMeteo/ARPAE ICON-2I single-run contract and 24-case validation plan prepared as a zero-traffic review candidate; S10 production runtime unavailable | Complete exact-head F4-A acceptance, expected-head merge and post-merge verification before F4-B machine-readable contract/fixture/validator | ADR-010; ADR-011; BKL-031-F3-C-BOUNDED-INTEGRATION-ACCEPTANCE-2026-09-17; BKL-031-F4-A-CONTRACT-001; BKL-031-F4-A-VAL-001 |
