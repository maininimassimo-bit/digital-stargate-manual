...
| BKL-034 | P2 | Scientific Image Gallery evoluta | Done | BKL-035, BKL-045, AP-015 semantic contract | Projection bounded/read-only di immagini, sessioni, target e processing provenance | Closure `docs/project/BKL-034-CLOSURE-2026-09-23.md`; BKL-033 closure |
