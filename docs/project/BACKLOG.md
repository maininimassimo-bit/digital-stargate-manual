...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-B Accepted/Post-Merge Verified through PR #259 and merge `8c3b7b8424a15b4288c79f773b9f0fc3f7cd5c5f`; 34/34 contract tests and 11/11 post-merge workflows passed; S10 runtime unavailable | Implement and validate the separately gated F3-C bounded adapter and sanitized projection without protected-site calculation, external-reference traffic or runtime activation | ADR-010; BKL-031-F3-A3-SCIENTIFIC-EXECUTION-EVIDENCE-001; BKL-031-F3-B-CONTRACT-001; BKL-031-F3-B-CONTRACTS-AND-VALIDATOR-ACCEPTANCE-2026-09-17 |
