...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-C Accepted/Post-Merge Verified with 35/35 tests; F4-A and ADR-011 Accepted/Post-Merge Verified; F4-B machine-readable forecast contracts, synthetic TEST/NONE fixture and deterministic validator pass 24/24 negative cases with zero provider traffic and zero provider calls; S10 production runtime unavailable | Complete exact-head F4-B acceptance and post-merge verification before the separately authorized F4-C bounded acquisition gate | ADR-010; ADR-011; BKL-031-F4-A-FORECAST-SOURCE-CONTRACT-ACCEPTANCE-2026-09-17; BKL-031-F4-B-CONTRACTS-001 |
