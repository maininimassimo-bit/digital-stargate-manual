...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-A3 exact scientific campaign passed: one successful remediated execution, 8 vectors, 17/17 metrics, repeatability and transit pass; ADR-010 Accepted for repository method authority; S10 runtime unavailable | Materialize F3-B machine-readable contracts and validator; retain stop before F3-C/runtime, protected-site calculation or external-reference traffic | ADR-010; BKL-031-F3-A3-SCIENTIFIC-EXECUTION-EVIDENCE-001; BKL-031-F3-A3-SCIENTIFIC-CAMPAIGN-ACCEPTANCE-2026-09-17 |
