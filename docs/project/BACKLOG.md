...
| BKL-046 | P2 | AI Post-Processing Assistant for PixInsight | In Progress | BKL-015/BKL-044/BKL-045 | Assistente advisory per ottimizzare workflow PixInsight | F1 CLOSED/ACCEPTED via PR #165, merge `3f2e3edae93b009f5800a58a4ac5afc4f04e9bb7`; F2 current for machine-readable Recommendation and Human Decision Receipt contracts; no model/provider or apply authority |
