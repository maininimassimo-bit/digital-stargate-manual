...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-A3 decisions and ARB-213-MI01/MI02 evidence complete; bootstrap, registry, exact OCI image and four-resource platform complete; exact approved kernel privately published and full-read-back verified; job unexecuted; ADR-010 Proposed; S10 unavailable | Prepare a separately reviewed exact scientific-spike execution gate; retain stop before execution, Horizons traffic, protected-site use or runtime activation until that gate completes | ADR-010; BKL-031-F3-A3-KERNEL-PUBLICATION-EVIDENCE-001; BKL-031-F3-A3-PLATFORM-APPLY-EVIDENCE-001; BKL-031-F3-A3-INFRA-001 |
