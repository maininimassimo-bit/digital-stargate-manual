...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-A3 decisions and ARB-213-MI01/MI02 evidence complete; bootstrap post-verified; exact static container/IERS identities and fail-closed source contract prepared; ADR-010 Proposed; S10 unavailable | Acquire exact artifacts and produce bounded container-build evidence without push, platform/scientific execution or runtime activation | ADR-010; BKL-031-F3-A3-CONTAINER-MANIFEST-001; ARB-213-MI02; BKL-031-F3-A3-INFRA-001 |
