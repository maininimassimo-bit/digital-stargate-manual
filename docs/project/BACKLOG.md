...
| BKL-036 | P2 | Observatory Health Score | In Progress | BKL-030, telemetry history | Source discovery and semantic contract first; future score remains distinct from Safety | `BKL-036-ARCH-001`, `BKL-036-VAL-001`; no runtime, thresholds, score or commands authorized |
