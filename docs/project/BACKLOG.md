...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F4 verificati; F5 technical evaluation preparata con limitation real-evidence e acceptance formale aperta; F6 chat AI read-only con citation/provenance è il prossimo incremento; funzioni operative restano separate e non autorizzate |
