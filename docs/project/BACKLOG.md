...
| BKL-043 | P2 | Observatory Reliability Engineering | In Progress | BKL-030/BKL-038/BKL-042 | SLI/SLO, MTBF, MTTR, session completion e failure budget | F1 source/population discovery and F2 two-plane logical architecture complete; F2 owner-approved 2026-09-24. Next is F3 read-only pilot readiness and authorization preparation, repository-only, with no live access or implementation: `docs/architecture/validation/BKL-043-F3-READONLY-PILOT-READINESS-GATE-2026-09-24.md`. Runtime technology, target, cadence, retention, source access and deployment remain unapproved; no collector, startup service, recurring writer, live source, threshold/SLO or authority change is authorized. |
