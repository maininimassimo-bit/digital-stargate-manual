...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-A3 Accepted/Post-Merge Verified; F3-B source-neutral method/request/evidence schemas, bounded synthetic fixture and fail-closed validator implemented with 34/34 local tests; S10 runtime unavailable | Complete exact-head F3-B acceptance and post-merge verification; then hand off separately to F3-C without protected-site calculation, external-reference traffic or runtime activation | ADR-010; BKL-031-F3-A3-SCIENTIFIC-EXECUTION-EVIDENCE-001; BKL-031-F3-B-CONTRACT-001; BKL-031-F3-B-CONTRACTS-AND-VALIDATOR-ACCEPTANCE-2026-09-17 |
...
ADR-010 is accepted for repository method authority, subject to exact-head and post-merge verification of the acceptance record. F3-A3 is complete at repository decision/evidence level. F3-B machine-readable contracts and validator are the next dependency-ready increment. F3-C, runtime S10, further cloud execution, protected-site calculation and external-reference traffic remain separately gated.
