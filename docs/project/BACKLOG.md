...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F4 verificati; F5 technical evaluation con acceptance formale aperta; F6 contract e consumer statico bounded preparati e in acceptance; runtime model/provider e funzioni operative restano separate e non autorizzate |
