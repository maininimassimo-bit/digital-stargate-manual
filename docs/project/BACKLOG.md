...
| BKL-034 | P2 | Scientific Image Gallery evoluta | In Progress | BKL-035, BKL-045, AP-015 semantic contract | Projection read-only di immagini, sessioni, target e processing provenance | Functional Roadmap Expansion; BKL-033 closure |
