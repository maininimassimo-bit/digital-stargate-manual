...
| BKL-036 | P2 | Observatory Health Score | In Progress | BKL-030, telemetry history | F3 archived-evidence score candidate: deterministic 0–100 public read-only projection; current result fail-closed `UNAVAILABLE` | F1/F2 accepted; F3 package in progress; no live telemetry, readiness, remediation or commands authorized |
