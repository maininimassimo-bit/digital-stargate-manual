...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F5 bounded ACCEPTED (`52403dfb`); F6 OAuth acceptance preesistente; primo retrieval/provenance limitato a sessioni e identità target deployato su `dsg-bkl042-ai-relay-00006-ktv` (PR #355, merge `b4d45c12`); owner-witnessed retrieval OAT post-deploy e source coverage residua pending. Storage/upload, processing, tool, command e Safety Authority restano esclusi |
