...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F4 verificati; F5 real-evidence validation è il prossimo gate; F6 chat AI read-only con citation/provenance è pianificata; funzioni operative restano separate e non autorizzate |
