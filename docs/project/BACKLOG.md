...
| BKL-043 | P2 | Observatory Reliability Engineering | In Progress | BKL-030/BKL-038/BKL-042 | SLI/SLO, MTBF, MTTR, session completion e failure budget | F1 source discovery complete. F2 logical design baseline owner-approved 2026-09-24: local read-only per-component observer + independently durable heartbeat witness + separately governed human-confirmed incident lifecycle; `docs/architecture/validation/BKL-043-F2-SYSTEM-DETECTION-ARCHITECTURE-2026-09-24.md`. Gate record: `docs/architecture/validation/BKL-043-F2-DETECTION-ARCHITECTURE-GATE-2026-09-24.md`. Runtime/technology/cadence/retention/source access remain unapproved; no collector, startup service, recurring writer, live source, threshold/SLO or authority change is authorized. |
