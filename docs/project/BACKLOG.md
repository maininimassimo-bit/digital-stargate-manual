...
| BKL-034-F2 | P2 | Governed Image Ingestion and Metadata Archive | In Progress | BKL-034, AP-013, AP-014, BKL-044, BKL-045; BKL-049 per native capture | Caricamento governato, checksum, quarantine, metadata archive e relazioni PixInsight | Contract, fixture, validator e storage-boundary dry-run preflight verificati; storage runtime scrivibile, upload authority e processing execution restano separati |
