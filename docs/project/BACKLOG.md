...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F5 bounded ACCEPTED (`52403dfb`); F6 OAuth acceptance preesistente; retrieval sessioni/identità target, PR #355; fix normalizzazione `M27`/`M 27` PR #357 (`7be9fd0b`), method v2 su relay `00007-wrm`, rollback `00006-ktv`; OAT live v2 `ANSWERED` owner-witnessed 24/09/2026, 5 citazioni verificate; formal bounded acceptance e decisione owner su copertura residua F1 pending. Storage/upload, processing, tool, command e Safety Authority restano esclusi |
