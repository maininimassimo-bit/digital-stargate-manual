...
| BKL-043 | P2 | Observatory Reliability Engineering | In Progress | BKL-030/BKL-038/BKL-042 | SLI/SLO, MTBF, MTTR, session completion e failure budget | F1 source/population discovery and F2 two-plane logical architecture complete; F2 owner-approved 2026-09-24. F3 owner approved preparation of a separate exact pilot authorization; offline tests pass locally/CI, while F3 review findings remain pending. F4 exact runtime authorization draft: `docs/architecture/validation/BKL-043-F4-EXACT-PILOT-RUNTIME-AUTHORIZATION-DRAFT-2026-09-24.md`. Every runtime target/source/cadence/witness/store/retention/boot/deployment field remains unselected; no runtime authorization, live access, collector, startup, recurring writer, relay change, incident register, threshold/SLO or authority change is granted. |
