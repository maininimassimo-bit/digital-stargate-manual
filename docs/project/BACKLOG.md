...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1/F2/F3 verificati; F4 consumer statico read-only con bounded freshness/accessibility in verifica; nessun modello/provider/runtime, command o Safety Authority |
