...
| BKL-034 | P2 | Scientific Image Gallery evoluta | In Progress | BKL-035, BKL-045, AP-015 semantic contract | Projection bounded/read-only di immagini, sessioni, target e processing provenance con consumer portale pubblico | Contract accepted; portal consumer, Pages rendering e acceptance end-to-end pending; reopened 2026-09-23 |
