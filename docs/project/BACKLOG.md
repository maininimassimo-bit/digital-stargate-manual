...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F5 bounded ACCEPTED (`52403dfb`); F6 OAuth acceptance preesistente; OAT live v2 `ANSWERED` owner-witnessed 24/09/2026. Su decisione owner, F7 estende il retrieval a BKL-037 descrittivo e BKL-041 solo sperimentale tramite method v3; evidence `docs/architecture/validation/BKL-042-F7-F1-SOURCE-COVERAGE-EVIDENCE-2026-09-24.md`; AI-assisted ARB/RQ `docs/architecture/reviews/ARB-BKL042-F7-SOURCE-COVERAGE-2026-09-24.md` e `RQ-BKL042-F7-SOURCE-COVERAGE-2026-09-24.md`. PR #360 merged in `6e6cf43fdf7d29d67d4800541049a4acdf7f42ee`; final-head e post-merge CI PASS. Relay v2; deployment del method v3 sull'istanza esistente ancora pending esclusivamente per OAT v3 owner-witnessed; BKL-042 non chiuso. Fonti senza projection fresca/produttiva restano escluse. Storage/upload, processing, tool, command e Safety Authority restano esclusi |
