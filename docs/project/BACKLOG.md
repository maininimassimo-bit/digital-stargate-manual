...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F5 bounded ACCEPTED (`52403dfb`); F6 OAuth acceptance preesistente; OAT live v2 `ANSWERED` owner-witnessed 24/09/2026. F7 estende il retrieval a BKL-037 descrittivo e BKL-041 solo sperimentale tramite method v3; PR #360 merged in `6e6cf43fdf7d29d67d4800541049a4acdf7f42ee`; final-head e post-merge CI PASS. Method v3 deployato sul relay esistente `dsg-bkl042-ai-relay-00008-qat`, 100% traffico, limite service/revision 1; rollback `00007-wrm`; deployment evidence `docs/architecture/validation/BKL-042-F7-V3-DEPLOYMENT-EVIDENCE-2026-09-24.md`. Owner OAT v3 per entrambe le nuove fonti e formal acceptance ancora pending; BKL-042 non chiuso. Fonti senza projection fresca/produttiva restano escluse. Storage/upload, processing, tool, command e Safety Authority restano esclusi |
