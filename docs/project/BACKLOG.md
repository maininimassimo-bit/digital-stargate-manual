...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | BKL-035; BKL-040; BKL-037; F3-C Accepted/Post-Merge Verified; F4-A/ADR-011; F4-B v1.1 Accepted/Post-Merge Verified; F4-C evidence reconciliation Accepted/Post-Merge Verified; F4-D metadata-only projection and portal Accepted/Post-Merge Verified; F5/F6/F7/F8 Accepted/Post-Merge Verified; F9 implementation/post-merge verified (PR #282/#283/#284); `F9_ZERO_EUR_GUARD=CONFIRMED`; no governed F9 refresh evidenced; S10 unavailable | Execute one governed F9 refresh, verify the sanitized current-night portal projection and complete acceptance reconciliation. Preserve two-acquisitions/day ceiling, fail-closed behavior, ephemeral GRIB/no retention, privacy, BKL-032 readiness separation and local physical-interlock Safety Authority. | ADR-012; PR #282 merge `deeafa6`; PR #283 merge `f3d9155`; PR #284 merge `3a80320`; `BKL-031-F9-Repeatable-Current-Night-Planner.md` |
