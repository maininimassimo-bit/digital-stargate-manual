...
| BKL-014 | P2 | Preparare AP-015 Scientific Knowledge Platform | Done | AP-014, BKL-015 e capability foundation soddisfatte; AP-015 semantic baseline accepted | Architecture Package CAP-40 | AMP-002; AP-015 closure |
...
| BKL-031 | P1 | Observation Planner intelligente | Done | BKL-035; BKL-040; BKL-037; F3-C Accepted/Post-Merge Verified; F4-A/ADR-011; F4-B v1.1 Accepted/Post-Merge Verified; F4-C evidence reconciliation Accepted/Post-Merge Verified; F4-D metadata-only projection and portal Accepted/Post-Merge Verified; F5/F6/F7/F8/F9 Accepted/Post-Merge Verified; provider budget 2/2 exhausted; zero-euro MeteoHub operating model under ADR-012; repository public; `F9_ZERO_EUR_GUARD=CONFIRMED`; S10 unavailable | Repeatable, fail-closed, read-only current-night planner for Manciano with no workflow-imposed daily acquisition limit, ephemeral GRIB/no retention, current astronomy, setup/target suitability, explainable ranking and forecast windows. Hourly meteo GO/NO-GO is advisory; ranked windows exclude any hour outside the F9 weather policy (cloud ≤20% planning constraint, rain 0, wind ≤15 km/h, gust ≤20 km/h, RH ≤90%, dew-point margin ≥10 °C). No operational readiness, dome authorization, decision scheduling, commands or Safety Authority; BKL-032 thresholds and local interlocks retain their authority. | PR #301; PR #373 merge `fd59ba711697efcd324af8a77ae78855fb174f40`; closure `docs/project/BKL-031-CLOSURE-2026-09-18.md`; F9 policy `docs/architecture/scientific-assets/BKL-031-F9-Repeatable-Current-Night-Planner.md` |
...
| BKL-033 | P2 | Observatory Digital Twin | Done | BKL-015/BKL-044, realtime telemetry, AP-015 semantic contract | Modello descrittivo/read-only di asset, dipendenze e stato | Functional Roadmap Expansion; closure `docs/project/BKL-033-CLOSURE-2026-09-23.md` |
| BKL-034 | P2 | Scientific Image Gallery evoluta | Done | BKL-035, BKL-045, AP-015 semantic contract | Projection bounded/read-only di immagini, sessioni, target e processing provenance con consumer portale pubblico | CLOSED / ACCEPTED / POST-MERGE VERIFIED; portal `/scientific-image-gallery/`, Pages rendering e workflow verificati; closure 2026-09-23 |
| BKL-034-F2 | P2 | Governed Image Ingestion and Metadata Archive | Done | BKL-034, AP-013, AP-014, BKL-044, BKL-045; BKL-049 per native capture | Caricamento governato, checksum, quarantine, metadata archive e relazioni PixInsight | CLOSED / ACCEPTED / POST-MERGE VERIFIED per contract e storage-boundary dry-run preflight; storage runtime scrivibile, upload authority e processing execution restano separati |
...
| BKL-036 | P2 | Observatory Health Score | Done | BKL-030, telemetry history | Bounded repository-only archived-evidence health projection | F1/F2/F3/F4 Accepted / Post-Merge Verified; F3 remains UNAVAILABLE by evidence policy; no live transport, runtime, readiness, remediation, scheduling or commands; closure `docs/project/BKL-036-CLOSURE-2026-09-19.md` |
| BKL-036-F5 | P2 | Live Read-Only Health Score | Done | AP-008 bounded read-only integration; BKL-036 F1-F4 | Seven-domain live descriptive score with fail-closed freshness and comparability gates | CLOSED / ACCEPTED / POST-MERGE VERIFIED; production EAGLE Health `HEALTHY/100`, GitHub Pages verified, owner-witnessed ARB/RQ evidence retained; no command path, remediation or Safety Authority; closure `docs/project/BKL-036-F5-CLOSURE-2026-09-23.md` |
...
| BKL-043 | P2 | Observatory Reliability Engineering | In Progress | BKL-030/BKL-038/BKL-042 | SLI/SLO, MTBF, MTTR, session completion e failure budget | F1 source/population discovery and F2 two-plane logical architecture complete; F2 owner-approved 2026-09-24. F3 offline tests pass locally/CI and review findings remain pending. F4 exact runtime authorization draft: `docs/architecture/validation/BKL-043-F4-EXACT-PILOT-RUNTIME-AUTHORIZATION-DRAFT-2026-09-24.md`. Scope and target `EAGLE30154` are selected, GitHub is a witness-provider candidate and Leonardo Di Egidio is nominated as independent reviewer; current host/OS attestation and every exact identity/artifact/source/private-witness-resource/receipt-store/transport/cadence/retention/boot/deployment field remain unselected. No runtime authorization, live access, collector, startup, recurring writer, relay change, incident register, threshold/SLO or authority change is granted. |
