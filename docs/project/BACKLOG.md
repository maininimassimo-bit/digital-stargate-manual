...
| BKL-043 | P2 | Observatory Reliability Engineering | In Progress | BKL-030/BKL-038/BKL-042 | SLI/SLO, MTBF, MTTR, session completion e failure budget | F1 source discovery complete. F2 architecture proposal `docs/architecture/validation/BKL-043-F2-SYSTEM-DETECTION-ARCHITECTURE-2026-09-24.md` recommends a two-plane, per-component observer plus independently durable heartbeat witness for the whole-system objective; owner/ARB decision pending. Gate definition: `docs/architecture/validation/BKL-043-F2-DETECTION-ARCHITECTURE-GATE-2026-09-24.md`. No collector, startup service, recurring writer, live source, threshold/SLO or authority change is authorized. |
