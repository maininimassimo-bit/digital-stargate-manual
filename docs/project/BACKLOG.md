...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-C Accepted/Post-Merge Verified with 35/35 tests; F4-A and ADR-011 Accepted/Post-Merge Verified through PR #263 and 13/13 post-merge workflows with zero provider traffic; S10 production runtime unavailable | Implement F4-B machine-readable request/source/evidence contracts, synthetic TEST/NONE fixture, validator and 24 fail-closed cases; stop before provider traffic | ADR-010; ADR-011; BKL-031-F3-C-BOUNDED-INTEGRATION-ACCEPTANCE-2026-09-17; BKL-031-F4-A-CONTRACT-001; BKL-031-F4-A-VAL-001; BKL-031-F4-A-FORECAST-SOURCE-CONTRACT-ACCEPTANCE-2026-09-17 |
