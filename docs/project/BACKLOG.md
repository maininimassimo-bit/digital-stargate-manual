...
| BKL-046 | P2 | AI Post-Processing Assistant for PixInsight | In Progress | BKL-015/BKL-044/BKL-045 | Assistente advisory per ottimizzare workflow PixInsight | Current package for architecture definition; human approval retained; implementation not yet accepted |
