...
| BKL-043 | P2 | Observatory Reliability Engineering | In Progress | BKL-030/BKL-038/BKL-042 | SLI/SLO, MTBF, MTTR, session completion e failure budget | F1 source inventory and population/contract gap discovery; owner-authorized next gate M-BKL043-F2 for system detection architecture review: `docs/architecture/validation/BKL-043-F2-DETECTION-ARCHITECTURE-GATE-2026-09-24.md`. N.I.N.A.-observed attempts exclude planned sessions with no N.I.N.A. activity. Gate is design-only; no collector, startup service, recurring writer, live source, threshold/SLO or authority change is authorized. |
