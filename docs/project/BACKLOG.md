...
| BKL-031 | P1 | Observation Planner intelligente | In Progress | F3-C Accepted/Post-Merge Verified through PR #261 and merge `fba1287efea0d1f36b147bc42a4fec5498990756`; 35/35 tests, 12/12 post-merge workflows and public portal route verified; S10 production runtime unavailable | Prepare the separately gated F4 forecast source discovery and integration contract without provider traffic, ranking, readiness, commands or Safety Authority | ADR-010; BKL-031-F3-B-CONTRACTS-AND-VALIDATOR-ACCEPTANCE-2026-09-17; BKL-031-F3-C-INTEGRATION-001; BKL-031-F3-C-BOUNDED-INTEGRATION-ACCEPTANCE-2026-09-17 |
