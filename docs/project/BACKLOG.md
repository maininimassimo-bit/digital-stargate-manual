...
| BKL-036-F5 | P2 | Live Read-Only Health Score | In Progress | AP-008 bounded read-only integration; BKL-036 F1-F4 | Seven-domain live descriptive score with fail-closed freshness and comparability gates | Owner-authorized implementation candidate; no score promotion, command path, remediation or Safety Authority |
