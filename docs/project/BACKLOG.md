...
| BKL-042 | P2 | AI Observatory Assistant | In Progress | BKL-015/BKL-044 e intelligence services | Copilot read-only per diagnosis/RCA/planning/science | F1-F5 bounded ACCEPTED con owner-witnessed baseline `52403dfb`; F6 portal Google OAuth, risposta live owner-witnessed e formal acceptance post-OAT registrate in `docs/architecture/validation/BKL-042-F6-PORTAL-OAUTH-OAT-EVIDENCE-2026-09-23.md`; retrieval/provenance runtime, storage/upload, processing, tool, command e Safety Authority restano gate separati |
