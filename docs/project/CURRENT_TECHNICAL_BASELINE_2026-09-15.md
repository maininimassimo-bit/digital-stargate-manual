...
## F3-A3 static container/IERS evidence delta — 16/09/2026

`BKL-031-F3-A3-CONTAINER-MANIFEST-001` at SHA-256 `7923206d85c5670ef56f9310a813c165c7d516d226c994561516c843b338412e` fixes the linux/amd64 base platform digest, exact Python wheel versions/hashes/licenses and IERS-A wheel SHA-256 `43786a0a9b60c7a55a85e12307c0050d75ea0679710378141255ded9d1bd8ebc`. The Dockerfile, offline Astropy configuration, entrypoint and preflight form a fail-closed future build contract. Static CI rejects drift and Terraform accepts only the reviewed IERS digest. No dependency or IERS bytes were acquired, no image was built or pushed, and no platform or scientific execution occurred.

## F3-A3 reproducible offline container-build evidence delta — 16/09/2026

Immutable source manifest `BKL-031-F3-A3-CONTAINER-MANIFEST-002` has SHA-256 `02ceba17c1ac97f780cd545554b254ee668d840fcd85e11310d07c4ecc37e879`. CI run `35122782246` acquired and hash-verified its ten exact artifacts ephemerally, then used pinned BuildKit `0.30.0` to produce two identical linux/amd64 image config IDs without cache or RUN network: `sha256:411df908f3938e0ff21b47986d4d5d9fcd91e1d0da3b64ffb00618aa48bbd5d0`. The non-root, network-disabled preflight verified the method profile, package versions, IERS wheel and campaign-date coverage. `BKL-031-F3-A3-CONTAINER-BUILD-EVIDENCE-001` has SHA-256 `00546062e78887af003adb010bb60dcfbdfb1480429e22314e4476673c7633a3`. The image config ID is not a registry digest; image push, artifact upload, platform plan/apply and scientific execution remain `NOT_EXECUTED`.
