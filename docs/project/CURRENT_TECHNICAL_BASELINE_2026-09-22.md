...
BKL-036-F5 is owner-authorized as an implementation candidate. It must define and validate
live seven-domain comparability, freshness and descriptive score semantics. The archived F3
