...
Le acceptance BKL-031 F1/F2 e l'integrazione dell'handoff F3 sono repository-only. Il package F3 corrente è documentale; nessuna azione PC/EAGLE è richiesta.
