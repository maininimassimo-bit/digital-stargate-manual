...
| Current governed package | F4-A forecast source discovery and single-run integration contract review candidate; zero provider traffic; S10 production runtime unavailable |
