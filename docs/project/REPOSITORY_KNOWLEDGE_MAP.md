...
| Current governed package | F3-C Accepted / Post-Merge Verified with public portal route; F4 forecast source discovery and integration contract next; S10 production runtime unavailable |
