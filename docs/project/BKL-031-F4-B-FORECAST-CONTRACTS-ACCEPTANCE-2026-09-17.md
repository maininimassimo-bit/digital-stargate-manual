...
The F4-C execution exposed a contract defect: v1.0 named the Previous Runs host while declaring the Single Runs interface, and included visibility although the official ICON-2I page marks it unavailable. The v1.1 correction uses `single-runs-api.open-meteo.com`, ten supported variables, explicit unavailable visibility and contract digest `22d547c5c91a713ff5ca6398a8eb13a1abdc9b4f90759c900f07a8c6ec90c954`. PR #269 passed 19/19 exact-head checks, merged as `053fc766bfc7908a984828cc335eef07a558909c` and passed 15/15 post-merge workflows. This correction record does not rewrite the historical evidence of PR #265.
