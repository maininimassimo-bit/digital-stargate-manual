...
| DLG-046 | 17/09/2026 | Correggere F4-B a v1.1 con Single Runs, escludere visibility non disponibile in ICON-2I e preparare un'unica richiesta sostitutiva F4-C con limite cumulativo due | Rimediare al difetto deterministico che ha consumato gate 001 senza produrre forecast evidence, preservando fail-closed e audit completo | BKL-031 F4-B/F4-C | Proposed / Replacement NOT EXECUTED | `BKL-031-F4-C-FAILURE-001`; `BKL-031-F4-C-GATE-002`; contract digest `22d547c5…` |
