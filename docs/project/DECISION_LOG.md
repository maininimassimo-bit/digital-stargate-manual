...
| DLG-042 | 17/09/2026 | Preparare F4-A con ItaliaMeteo/ARPAE ICON-2I come modello forecast candidato e Open-Meteo Single Runs come delivery interface vincolata a modello e run espliciti | Preservare provider/model/run, validità e applicabilità spaziale; impedire best-match, stitching e fallback silenzioso prima di schema, traffico provider o uso del sito protetto | BKL-031 F4-A | Proposed / review candidate | `BKL-031-F4-A-CONTRACT-001`; proposed ADR-011; `BKL-031-F4-A-VAL-001` |
