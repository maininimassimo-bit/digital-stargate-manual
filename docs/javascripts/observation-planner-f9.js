...
if(root){
 ...
 try{
  ...
  if((Date.now()-Date.parse(f.runInitialisationUtc))/3600000>18)throw new Error('forecast stale oltre 18 ore');
  if(b.maximumAcquisitionsPerDay!==2||b.monetaryBudgetEur!==0||b.rawGribRetention!=='NONE_EPHEMERAL_ONLY'||b.readinessAuthority!==false||b.schedulingAuthority!==false||b.commandAuthority!=='NONE'||b.safetyAuthority!=='LOCAL_PHYSICAL_INTERLOCKS'||b.protectedCoordinatesPublished!==false)throw new Error('boundary F9 non valida');
