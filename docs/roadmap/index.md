# Roadmap Digital StarGate

<div class="dsg-roadmap-app" data-roadmap-source="../data/roadmap.json">
  <header class="dsg-roadmap-hero">
    <div>
      <span class="dsg-roadmap-kicker">PROGRAMMA ARCHITETTURALE</span>
      <h2>Roadmap completa del progetto</h2>
      <p>Stato corrente, milestone principali e prossimi Architecture Package, derivati dalla roadmap autorevole AMP-002.</p>
    </div>
  ...
  <section class="dsg-roadmap-milestones">
    <div class="dsg-roadmap-section-heading">
      ...
      <p>Ogni milestone completata può pubblicare una propria immagine di avanzamento tramite il campo <code>image</code> nel registro dati.</p>
    </div>
