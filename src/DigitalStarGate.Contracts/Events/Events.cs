...
public sealed record ExposureStarted(Guid EventId, DateTimeOffset OccurredAt, CorrelationId CorrelationId, CausationId? CausationId, string Version, ObservationSessionId SessionId, ExposureTime ExposureTime) : PlatformEvent(EventId, OccurredAt, CorrelationId, CausationId, Version);
